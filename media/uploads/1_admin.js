...
;
/****** FILE: media/js/jquery.base64.js *****/
...
;
/****** FILE: media/js/admin.js *****/

function info_search(){$("#info-search").submit();}
function show_addedit(toggle){var addEditForm=$("#addedit");if(toggle){addEditForm.toggle(400);}else{addEditForm.show(400);}
$(':input','#addedit').not(':button, :submit, :reset, #action, :checkbox, [name="form_auth_token"]').val('').removeAttr('selected');$(':checkbox','#addedit').removeAttr('checked');$("a.add").focus();}
;
/****** FILE: media/js/jquery.hovertip-1.0.js *****/
